...
array( "name" => "mouse over category breadcrumbs",
	"desc" => "choose the top most category to display the breadcrumbs on the image mouse over",
	"id" => $shortname."_breadcrumbs_cat",
	"type" => "select",
	"options" => $wp_cats,
	"std" => "continents"
),
array( "name" => "Gallery image padding",
	"desc" => "padding in pixels",
	"id" => $shortname."_gallery_padding",
	"type" => "text",
	"size" => "40px",
	"std" => "1",
),
array( "name" => "Gallery sides margin",
	"desc" => "margin in pixels. -15 will cover the whole screen side to side",
	"id" => $shortname."_gallery_margin",
	"type" => "text",
	"size" => "40px",
	"std" => "-15",
),
array( "name" => "columns width xs (12 total)",
	"desc" => "responsive column width. This will be shown in extra small screens. Default 6 (aka: 2 images per row).",
	"id" => $shortname."_gallery_col_xs",
	"type" => "text",
	"size" => "40px",
	"std" => "6",
),
array( "name" => "columns width sm (12 total)",
	"desc" => "responsive column width. This will be shown in small screens. Default 4 (aka: 3 images per row).",
	"id" => $shortname."_gallery_col_sm",
	"type" => "text",
	"size" => "40px",
	"std" => "4",
),
array( "name" => "column width md (12 total)",
	"desc" => "responsive column width. This will be shown in medium size screen. Default 4 (aka: 3 images per row).",
	"id" => $shortname."_gallery_col_md",
	"type" => "text",
	"size" => "40px",
	"std" => "4",
),
array( "name" => "column width lg (12 total)",
	"desc" => "responsive column width. This will be shown in normal and big screens. Default 3 (aka: 4 images per row).",
	"id" => $shortname."_gallery_lg",
	"type" => "text",
	"size" => "40px",
	"std" => "3",
),
